<header class="ltn__header-area ltn__header-3 section-bg-6 ltn__header-transparent">        
                        ...
                        <nav>
                            <div class="ltn__main-menu">
                                <ul>
                                    ...
                                    <li class="menu-icon"><a href="/about">About Us</a>
                                        
                                    </li>
                                    <li class="menu-icon"><a href="/catalogue">Catalogue</a>
                                    </li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="mini-cart-icon mini-cart-icon-2">
                                    <a href="service.html" class="theme-btn-1 btn btn-round" style="font-size: 16px; padding: 8px 18px; ">Shop Now</a>
                                </div>
                            </li>
                            <li>      
                                <!-- Mobile Menu Button -->
